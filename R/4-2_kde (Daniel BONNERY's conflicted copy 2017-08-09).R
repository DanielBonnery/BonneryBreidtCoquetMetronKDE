...
pifun1<-function(Obs,xihat=function(Obs){1}){
  
}

#kde for rho*f in the numerator, known pi with known xi in the denominator. (infeasible)
#kde for rho*f in the numerator, known pi  with design-weighted estimates of xi in the denominator. (sometimes feasible)
#kde for rho*f in the numerator, unknown pi estimated via design-weighted parametric methods in the denominator. (feasible)
#kde for rho*f in the numerator, unknown pi estimated via design-weighted nonparametric methods in the denominator. 
...
#(design-weighted Nadaraya-Watson estimato of 1/pi)
